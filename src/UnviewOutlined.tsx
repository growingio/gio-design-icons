...
function SvgUnviewOutlined(wrapperProps: IconProps) {
  ...
  const file = (
    ...
    >
      ...
      <g id="unview-outlined_svg__Layer_2" data-name="Layer 2">
        <path
          ...
          fill="currentColor"
          fillRule="evenodd"
          id="unview-outlined_svg__Layer_1-2"
          data-name="Layer 1"
        />
      </g>
    </svg>
...
export default SvgUnviewOutlined;
