...
function SvgSuccessCircleOutlined(wrapperProps: IconProps) {
  ...
  const file = (
    ...
    >
      ...
      <g
        id="success-circle-outlined_svg__\u56FE\u5C42_2"
        data-name="\u56FE\u5C42 2"
      >
        <g
          id="success-circle-outlined_svg__\u56FE\u5C42_1-2"
          data-name="\u56FE\u5C42 1"
        >
          <g id="success-circle-outlined_svg__succeed" fill="#323333">
            <path
...
export default SvgSuccessCircleOutlined;
