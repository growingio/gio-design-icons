...
function SvgCloseCircleOutlined(wrapperProps: IconProps) {
  ...
  const file = (
    ...
    >
      ...
      <g
        id="close-circle-outlined_svg__\u56FE\u5C42_2"
        data-name="\u56FE\u5C42 2"
      >
        <g
          id="close-circle-outlined_svg__\u56FE\u5C42_1-2"
          data-name="\u56FE\u5C42 1"
        >
          <path
            ...
            fill="currentColor"
            fillRule="evenodd"
            id="close-circle-outlined_svg__defeat"
          />
        </g>
      </g>
    </svg>
