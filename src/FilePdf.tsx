...
function SvgFilePdf(wrapperProps: IconProps) {
    ...
    >
      <g>
        <clipPath id="file-pdf_svg__a">
          <path
            d="M7 0h15l8 8v19a3 3 0 01-3 3H7a3 3 0 01-3-3V3a3 3 0 013-3z"
            fill="currentColor"
          />
        </clipPath>
